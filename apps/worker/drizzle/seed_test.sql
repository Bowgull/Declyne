...
INSERT OR REPLACE INTO merchants (id, display_name, normalized_key, category_default_id, verified) VALUES
  ...
  ('m_banhmi',      'Banh Mi Boys',         'banh mi boys',            'cat_fastfood',      1),
  ('m_goldenturtle','Golden Turtle',        'golden turtle',           'cat_fastfood',      1),
  ('m_pai',         'Pai Northern Thai',    'pai northern',            'cat_fastfood',      1),
  ('m_ladymarm',    'Lady Marmalade',       'lady marmalade',          'cat_fastfood',      1),
  ('m_barraval',    'Bar Raval',            'bar raval',               'cat_alcohol',       1),
  ...
  ('m_uber',        'Uber Eats',            'uber eats',               'cat_fastfood',      1),
...
INSERT OR REPLACE INTO transactions (id, account_id, posted_at, amount_cents, description_raw, merchant_id, category_id, dedup_hash, source, created_at) VALUES
  ...
  ('tx_v_dn01','acc_td_visa','2026-02-20', -1620,'BANH MI BOYS QUEEN','m_banhmi',    'cat_fastfood','h_v_dn01','csv','2026-02-20T13:00:00Z'),
  ('tx_v_dn02','acc_td_visa','2026-03-08', -6240,'PAI NORTHERN THAI', 'm_pai',       'cat_fastfood','h_v_dn02','csv','2026-03-08T19:30:00Z'),
  ('tx_v_dn03','acc_td_visa','2026-03-22', -1840,'BANH MI BOYS QUEEN','m_banhmi',    'cat_fastfood','h_v_dn03','csv','2026-03-22T13:00:00Z'),
  ('tx_v_dn04','acc_td_visa','2026-04-05', -4280,'LADY MARMALADE',    'm_ladymarm',  'cat_fastfood','h_v_dn04','csv','2026-04-05T10:30:00Z'),
  ('tx_v_dn05','acc_td_visa','2026-04-19', -1760,'BANH MI BOYS QUEEN','m_banhmi',    'cat_fastfood','h_v_dn05','csv','2026-04-19T13:00:00Z'),
  ('tx_v_dn06','acc_td_visa','2026-05-03', -2840,'GOLDEN TURTLE',     'm_goldenturtle','cat_fastfood','h_v_dn06','csv','2026-05-03T19:00:00Z'),
  ('tx_v_dn07','acc_td_visa','2026-05-10', -1580,'BANH MI BOYS QUEEN','m_banhmi',    'cat_fastfood','h_v_dn07','csv','2026-05-10T13:00:00Z'),

  -- Uber Eats: 2x/month. Comfort spending, usually Friday night.
  ('tx_v_ue01','acc_td_visa','2026-02-21', -3240,'UBER EATS TORONTO','m_uber','cat_fastfood','h_v_ue01','csv','2026-02-21T20:00:00Z'),
  ('tx_v_ue02','acc_td_visa','2026-03-07', -2980,'UBER EATS TORONTO','m_uber','cat_fastfood','h_v_ue02','csv','2026-03-07T20:00:00Z'),
  ('tx_v_ue03','acc_td_visa','2026-03-20', -3420,'UBER EATS TORONTO','m_uber','cat_fastfood','h_v_ue03','csv','2026-03-20T20:00:00Z'),
  ('tx_v_ue04','acc_td_visa','2026-04-04', -2760,'UBER EATS TORONTO','m_uber','cat_fastfood','h_v_ue04','csv','2026-04-04T20:00:00Z'),
  ('tx_v_ue05','acc_td_visa','2026-04-18', -3180,'UBER EATS TORONTO','m_uber','cat_fastfood','h_v_ue05','csv','2026-04-18T20:00:00Z'),
  ('tx_v_ue06','acc_td_visa','2026-05-02', -2920,'UBER EATS TORONTO','m_uber','cat_fastfood','h_v_ue06','csv','2026-05-02T20:00:00Z'),
  ('tx_v_ue07','acc_td_visa','2026-05-09', -3360,'UBER EATS TORONTO','m_uber','cat_fastfood','h_v_ue07','csv','2026-05-09T20:00:00Z'),
...
INSERT OR REPLACE INTO transactions (id, account_id, posted_at, amount_cents, description_raw, merchant_id, category_id, dedup_hash, source, created_at) VALUES
  ...
  ('tx_c_dn01','acc_capone','2026-03-21', -3640,'BAR RAVAL',           'm_barraval',  'cat_alcohol' ,  'h_c_dn01','csv','2026-03-21T21:00:00Z'),
  ('tx_c_dn02','acc_capone','2026-04-11', -1680,'BANH MI BOYS QUEEN',  'm_banhmi',    'cat_fastfood',  'h_c_dn02','csv','2026-04-11T13:00:00Z'),
  ('tx_c_dn03','acc_capone','2026-05-09', -1920,'BANH MI BOYS QUEEN',  'm_banhmi',    'cat_fastfood',  'h_c_dn03','csv','2026-05-09T13:00:00Z'),
