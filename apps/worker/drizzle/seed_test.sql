...
INSERT OR REPLACE INTO splits (id, counterparty, counterparty_id, direction, original_cents, remaining_cents, reason, created_at, closed_at) VALUES
  ('split_marcus_brunch','Marcus Chen',  'cp_marcus','owes_josh',4750,4750,'Lady Marmalade brunch','2026-05-09T15:30:00Z',NULL),
  ('split_priya_tapas',  'Priya Shah',   'cp_priya', 'josh_owes',8200,8200,'Bar Raval tapas',      '2026-05-05T22:10:00Z',NULL),
  ('split_diego_pho',    'Diego Alvarez','cp_diego', 'owes_josh',3600,3600,'Golden Turtle dinner', '2026-05-11T20:45:00Z',NULL);
