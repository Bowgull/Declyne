...
INSERT OR REPLACE INTO splits (id, counterparty_id, direction, original_cents, remaining_cents, reason, created_at, closed_at) VALUES
  ('split_bowgull_mexico','cp_bowgull','josh_owes',150000,120000,'Mexico trip','2026-01-20T12:00:00Z',NULL),
  ('split_marcus_brunch','cp_marcus','owes_josh',4750,4750,'Lady Marmalade brunch','2026-04-19T15:30:00Z',NULL),
  ('split_priya_tapas','cp_priya','josh_owes',8200,8200,'Bar Raval tapas','2026-04-15T22:10:00Z',NULL),
  ('split_diego_pho','cp_diego','owes_josh',3600,3600,'Golden Turtle dinner','2026-04-21T20:45:00Z',NULL);
