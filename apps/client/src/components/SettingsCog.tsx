...
interface Props {
  // For visual offset when the cog sits at the right edge of a header bar.
  edge?: boolean;
}

export default function SettingsCog({ edge }: Props) {
  return (
    <Link
      to="/settings"
      aria-label="Open settings"
      className="header-icon-btn"
      style={edge ? { marginRight: -10 } : undefined}
    >
      <svg
        width="20"
        height="20"
